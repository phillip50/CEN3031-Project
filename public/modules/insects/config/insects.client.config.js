...
angular.module('insects').run(['Menus',
	function(Menus) {
		...
		Menus.addSubMenuItem('topbar', 'insects', 'All Insects', 'insects', null, true, null, null,"See everyone's caught insects");
		...
		Menus.addSubMenuItem('topbar', 'insects', 'New Insect', 'insects/create', null, false, null, null,"Upload your insect photo");
	}
]);
